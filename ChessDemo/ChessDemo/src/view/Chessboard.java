...
public class Chessboard extends JComponent {
    ...
    private final AIController1 aiController1=new AIController1(this);
...
//    public boolean checked;
    ...
    public Chessboard(int width, int height,Mode mode) {
    ...
    //store what we have done in the arraylist storingSteps
...
//                storingSteps.add("R0H0B0Q0K0B0H0R0#P0P0P0P0P0P0P0P0#e0e0e0e0e0e0e0e0#e0e0e0e0e0e0e0e0#e0e0e0e0e0e0e0e0#e0e0e0e0e0e0e0e0#p0p0p0p0p0p0p0p0#r0h0b0q0k0b0h0r0#1#0000#");
        ...
        //FIXME: 当棋子为白色时，希望能够同时移动黑色棋子
//        if (mode.equals(Mode.Ai1)&&currentColor.equals(ChessColor.WHITE)){
//            aiController1.chessReallyGo();
//
//
//        }
