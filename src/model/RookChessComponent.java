...
public class RookChessComponent extends ChessComponent {
    ...
    private static Image rb;
    private static Image rw;
    ...
    public void loadResource() throws IOException {
        ...
        if(rb==null){
            rb = ImageIO.read(new File("./images/blackrook.png"));
        } if(rw==null){
            rw= ImageIO.read(new File("./images/whiterook.png"));
        }
    }
...
//        g.drawImage(rookImage, 0, 0, getWidth() - 13, getHeight() - 20, this);
        ...
        g.setColor(Color.BLACK);}
            ...
            g.drawImage(rookI, 0, 0, getWidth(), getHeight(), this);
            g.setColor(Color.BLACK);
        }
