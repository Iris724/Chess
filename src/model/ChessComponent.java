...
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    ...
    //if this component is moved
    private boolean stayTillNow= true;
//a private variable remember to call it by getter
    ...
    protected void processMouseEvent(MouseEvent e) {
        ...
        if (e.getID() == MouseEvent.MOUSE_PRESSED) {
            ...
            try{
                FileInputStream file=new FileInputStream("clickMusic.wav");
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (ChessGameFrame.isChanged){
            super.paintComponents(g);
            Color squareColor1 = BACKGROUND_COLORS1[(chessboardPoint.getX()+chessboardPoint.getY())%2];
